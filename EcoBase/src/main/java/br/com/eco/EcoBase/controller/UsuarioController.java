...
import br.com.eco.EcoBase.service.UsuarioService;
...
public class UsuarioController {
	...
	public ResponseEntity<List<Usuario>> getAllByName(@Valid @PathVariable String nome){
		return ResponseEntity.ok(this.service.getAllByNome(nome));
	}
	
	@GetMapping("/usuario/nome/{nome}")
	public ResponseEntity<Usuario> getByName(@Valid @PathVariable String nome){
