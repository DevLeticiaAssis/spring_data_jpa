...
public class CategoriaController {
	...
	@GetMapping("/categoria/nomes/{nome}")
	public ResponseEntity<List<Categoria>> getAllByName(@Valid @PathVariable String nome){
		return ResponseEntity.ok(this.service.getAllByNome(nome));
	}
	
	@GetMapping("/categoria/nome/{nome}")
	public ResponseEntity<Categoria> getByName(@Valid @PathVariable String nome){
