...
import br.com.eco.EcoBase.service.ProdutoService;
...
public class ProdutoController {
	...
	@GetMapping("/produto/nomes/{nome}")
	public ResponseEntity<List<Produto>> getAllByName(@Valid @PathVariable String nome){
		return ResponseEntity.ok(this.service.getAllByNome(nome));
	}
	
	@GetMapping("/produto/nome/{nome}")
	public ResponseEntity<Produto> getByName(@Valid @PathVariable String nome){
